...
namespace MathGame
{
    internal class Helpers
    {
        internal static List<Game> games = new List<Game>
        {
            ...
            //new Game { Date = DateTime.Now.AddDays(12), Type = GameType.Substraction, Score = 2 },
        ...
        internal static void PrintGames()
        {
           ...
           /* var gamesToPrintFilteredByDate = games.Where(x => x.Date > new DateTime(2023, 10, 02) && x.Score > 3).OrderByDescending(x => x.Score); then change in foreach */
